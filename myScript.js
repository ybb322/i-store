...
new RGBELoader()
.setPath('files/')
.load('moonless_golf_2k.hdr', function (texture){
...
let iMac;
    loaderGLTF.load('./files/imac/scene.gltf', function (gltf) {
    iMac = gltf.scene;
    scene.add(iMac);
    iMac.position.x = 28;
    iMac.position.y = -0.2;
...
let macBook;
    loaderGLTF.load('./files/macbook_air/scene.gltf', function (gltf){
    macBook = gltf.scene;
    scene.add(macBook);
...
let airPodsMax;
    loaderGLTF.load('./files/airpods_max_pink/scene.gltf', function (gltf) {
...
let iPhone13
    loaderGLTF.load( './files/iphone_13/scene.gltf', function ( gltf ) {
    iPhone13 = gltf.scene;
...
let iPhone13two;
    loaderGLTF.load( './files/iphone_13/scene_nice.gltf', function ( gltf ) {
